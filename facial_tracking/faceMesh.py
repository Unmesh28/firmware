...
# When MediaPipe is not available (e.g. 32-bit armhf), use direct TFLite inference.
# The TFLite version provides the same FaceMesh class interface.
if not _HAS_MEDIAPIPE:
    from facial_tracking.faceMeshTFLite import FaceMesh
else:
